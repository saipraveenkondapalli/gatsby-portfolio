...
function PrivacyPolicy() {
  return (
    <BlogLayout>
      ...
      <Text>Last updated: February 10, 2024</Text>
      <BlogText>
      ...
      <BlogHeading>Interpretation and Definitions</BlogHeading>
      ...
      <BlogList type={"unordered"}>
        ...
        <BlogListItem>
          ...
          this Agreement) refers to Sai Praveen.
        </BlogListItem>
        <BlogListItem>
        ...
        <BlogListItem>
          <strong>Website</strong> refers to Sai Praveen, accessible from{" "}
          <a
            href="https://saipraveen.me"
      ...
      <BlogHeading>Collecting and Using Your Personal Data</BlogHeading>
      <Heading as={"h3"} my={2} fontSize={"2xl"}>
      ...
      <BlogList type={"unordered"}>
        <BlogListItem>Email address</BlogListItem>
        <BlogListItem>First name and last name</BlogListItem>
        <BlogListItem>Usage Data</BlogListItem>
      </BlogList>
      ...
      <BlogText>
        ...
        <BlogLink href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies">
          TermsFeed website
        </BlogLink>{" "}
        article.
      </BlogText>
      <BlogText>
        To comply with privacy regulations, such as the General Data Protection
        Regulation (GDPR) in the European Union, we utilize CookieBot. CookieBot
        assists us in managing cookie preferences and obtaining user consent.
        Through CookieBot, users have the option to accept or reject specific
        types of cookies, such as functional cookies, advertising cookies, and
        analytical cookies. This empowers users to make informed choices about
        their online privacy preferences. Additionally, CookieBot enables us to
        implement features such as cookie consent banners or pop-ups, cookie
        policy generation, and cookie scanning to identify and categorize
        cookies used on our website. By using Our Service, You consent to the
      ...
      <BlogList type={"unordered"}>
        <BlogListItem>Comply with a legal obligation</BlogListItem>
        <BlogListItem>
        ...
        <BlogListItem>Protect against legal liability</BlogListItem>
      </BlogList>
      <Heading as={"h3"} fontSize={"2xl"}>
      ...
      <BlogHeading>Children's Privacy</BlogHeading>
      <BlogText>
      ...
      <BlogHeading>Links to Other Websites</BlogHeading>
      <BlogText>
      ...
      <BlogHeading>Contact Us</BlogHeading>
      <BlogText>
      ...
      <BlogList type={"unordered"}>
        <BlogListItem>
          ...
          <Link color={"teal"} href="https://saipraveen.me/contact">
            https://saipraveen.me/contact
          </Link>
        </BlogListItem>
      </BlogList>
    </BlogLayout>
